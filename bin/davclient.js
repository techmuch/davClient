define([
    ...
    /*
        ...
        Copyright (C) 2004-2013 Guido Wesdorp
        email johnnydebris at gmail dot com
    ...
    */
    ...
    global.davlib = new function() {
        ...
        */
        ...
        this.MultiStatusSAXHandler.prototype = new minisax.SAXHandler;
            ...
            while (elements.length) {
                ...
                for (var i = 0; i < elements.length; i++) {
                    ...
                    if (path.length == root.path.length + 1) {
                        ...
                        for (var j = root.path.length; j < path.length - 1; j++) {
        ...
        this.LockinfoSAXHandler.prototype = new minisax.SAXHandler;
