define([], function() {
    /*
        ...
        Note: previous versions of this library were distributed under terms of
        the General Public License v2 or later - if desired, these terms may be
        applied instead of those of the minisax.js license.
    ...
    */
    ...
    var global = this;
    global.minisax = new function minisax() {
        function SAXParser() {
            /* Simple SAX library
                ...
                if (chunk.charAt(0) == '<') {
                    if (chunk.charAt(1) == '/') {
                        ...
                        if (chunk.indexOf('-->') != (chunk.length - 3)) {
                            var more = xml.substr(0, xml.indexOf('-->') + 3);
        ...
        SAXParser.prototype.handleStartTag = function(tag, is_singleton) {
            ...
            this._getAndHandleNamespaceDeclarations(attrs);
        ...
        SAXParser.prototype._getAndHandleNamespaceDeclarations =
            function(attrarray) {
        ...
        this.expose_globals = function expose_globals() {
            /* expose the SAXParser and SAXHandler vars globally
        
               use this for older libs that use the globals
            */
            global.SAXParser = SAXParser;
            global.SAXHandler = SAXHandler;
        };
    }();
