define([], function() {
    ...
    global.exception = new function() {
        ...
        this.NameError = function(message) {
            /* raised on providing invalid values */
            if (message !== undefined) {
                this._initialize('NameError', message);
            };
        };

        this.NameError.prototype = new this.Exception;

        this.KeyError = function(message) {
            /* raised on providing invalid values */
            if (message !== undefined) {
                this._initialize('KeyError', message);
            };
        };

        this.KeyError.prototype = new this.Exception;
